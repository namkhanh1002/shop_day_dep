<?php
$view_account = [];
if (isset($data_taikhoan) && is_array($data_taikhoan)) {
	$view_account = $data_taikhoan;
}
$data_taikhoan = array_merge([
	'idUser' => '',
	'ho' => '',
	'ten' => '',
	'email' => '',
						...
						<ul class="panel-group" id="accordion">
							...
							<li class="panel">
								...
								<div id="collapse4" class="panel-collapse collapse">
									<div class="single-log-info">
										<div class="custom-input">
											<form action="?action=suataikhoan" method="post" onsubmit="return validate()">
												...
												<div class="submit-text text-left">
													<button type="submit" value="submit form">Lưu</button>
												</div>
											</form>
										</div>
									</div>
