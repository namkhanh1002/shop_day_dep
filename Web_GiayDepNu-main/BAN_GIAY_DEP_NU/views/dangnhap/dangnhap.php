                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="tendangnhap_dn" class="form-control" required>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                                                ...
                                                                <input type="password" name="matkhau_dn" class="form-control" required>
                                        ...
                                        <div class="onee" style="background-color: lightgray;">
                                            ...
                                            <form action="?action=dangky_xl" method="POST" class="form" role="form" onsubmit="return validate()">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input id="mk2" class="form-control" type="password" name="matkhau_confirm" placeholder="Nhập lại mật khẩu" required>
                                                </div>
